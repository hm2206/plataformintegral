                        ...
                        <Form className="row justify-content-center">
                            <div className="col-md-8">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mt-3">
                                        <Form.Field error={errors && errors.dependencia_origen_id && errors.dependencia_origen_id[0] || ""}>
                                            <label htmlFor="">Procedencia del Documento <b className="text-red">*</b></label>
                                            <Select
                                                value={form.dependencia_origen_id || ""}
                                                name="dependencia_origen_id"
                                                options={dependencias}
                                                placeholder="Select. Procedencia del Documento"
                                                onChange={(e, obj) => this.handleInput(obj)}
                                            />
                                            <label>{errors && errors.dependencia_origen_id && errors.dependencia_origen_id[0] || ""}</label>
                                        </Form.Field>
                                    </div>
