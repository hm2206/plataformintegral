...
const CreateWork = ({ pathname }) => {
    ...
    const save = async () => {
        ...
        payload.bankId = parseInt(payload.bankId);
                            ...
                            <Form className="row justify-content-center">
                                <div className="col-md-9">
                                    <div className="row justify-content-end">
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <Form.Field error={errors.bankId && errors.bankId[0] ? true : false}>
                                                ...
                                                <SelectBank
                                                    ...
                                                    disabled={current_loading}
                                                />
                                                <label>{errors.bankId && errors.bankId[0]}</label>
                                            </Form.Field>
                                        </div>

                                        <div className="col-md-6 mb-3">
                                            <Form.Field error={errors.numberOfAccount && errors.numberOfAccount[0] ? true : false}>
                                                ...
                                                <input
                                                    ...
                                                    disabled={current_loading}
                                                />
                                                <label>{errors.numberOfAccount && errors.numberOfAccount[0]}</label>
                                            </Form.Field>
                                        </div>
