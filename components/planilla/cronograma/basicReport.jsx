...
const getButtons = async (names = []) => {
    let datos = [
        ...
        {value: "judicial-pay", text: "Generar Pagos", color: "red", icon: "file text outline", url: "pdf/judicial/{id}/pago", params: ["id"], action: "link", api: "microPlanilla"},
...
const reports = [
    ...
    {key: "obligacion", value: "obligacion", text: "Reporte de Obl. Judiciales", icon: "file text outline", filtros: ['isCheck', 'typeCategoryId'], buttons: ['judicial', 'judicial-pay-txt']},
