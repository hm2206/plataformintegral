...
const OnomasticoConfig = ({ setFile = null, setBlock = null }) => {
    ...
    const reportPdf = useRequestBlob({ request: reportProvider.onomastico, name: "report-onomastico.pdf", extname: "pdf" });
    const reportExcel = useRequestBlob({ request: reportProvider.onomastico, name: "report-honomastico.xlsx", extname: "xlsx" });
...
export default OnomasticoConfig;