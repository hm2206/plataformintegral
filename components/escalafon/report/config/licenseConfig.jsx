...
const LicenseConfig = ({ setFile = null, setBlock = null }) => {

    const [form, setForm] = useState({});

    const reportPdf = useRequestBlob({ request: reportProvider.licenses, name: "report-license.pdf", extname: "pdf" });
    const reportExcel = useRequestBlob({ request: reportProvider.licenses, name: "report-license.xlsx", extname: "xlsx" });
