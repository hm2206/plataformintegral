...
const InfoConfig = ({ setFile = null, setBlock = null }) => {

    const [form, setForm] = useState({});

    const reportPdf = useRequestBlob({ request: reportProvider.infos, name: "report-contrato.pdf", extname: "pdf" });
    const reportExcel = useRequestBlob({ request: reportProvider.infos, name: "report-contrato.xlsx", extname: "xlsx" });
