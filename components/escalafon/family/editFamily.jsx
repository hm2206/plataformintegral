...
import FormDesgrees from './formFamily';
...
const EditFamily = ({ license = {}, onClose = null, onUpdate = null, onDelete = null }) => {
    ...
    return (
        <Modal isClose={onClose}
            ...
            titulo={<span><i className="fas fa-calendar"></i> Editar Fomiliar</span>}
        >
