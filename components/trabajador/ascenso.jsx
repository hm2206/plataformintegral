...
const Ascenso = ({ work }) => {
    ...
    const getGrado = async (add = false) => {
        ...
        await escalafon.get(`work/${work.id}/ascenso?page=${current_page}`)
            .then(res => {
                let { success, message, ascensos } = res.data;
                if (!success) throw new Error(message);
                setError(false);
                setCurrentTotal(ascensos.total);
                setCurrentLastPage(ascensos.last_page);
                setCurrentData(add ? [...current_data, ...ascensos.data] : ascensos.data);
            })
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-md-10">
                                ...
                                <div className="mb-2"><b>Tip. Categoría: </b> {d.type_categoria && d.type_categoria.descripcion}</div>
                            </div>
